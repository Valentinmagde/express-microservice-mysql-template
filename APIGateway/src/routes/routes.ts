...
import swaggerOptions from "../storage/api-docs/api-docs.json";
...
import authSwaggerOptions from '../authentication.modules/storage/authentication-docs/authentication-docs.json';
